...
class CarSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cars = [
            [
                'make' => 'Toyota', 'model' => 'Camry', 'year' => 2024, 'trim' => 'GCC Spec',
                'region' => 'GCC',
                ...
                'description_en' => 'Toyota Camry 2024 GCC Spec - 2.5L engine, built for Middle East.',
                'description_ku' => 'تۆیۆتا کامری ٢٠٢٤ تایبەتمەندی کەنداو.',
            ],
            [
                ...
                'fuel_combined_l_100km' => 7.4, 'fuel_city_l_100km' => 9.0, 'fuel_highway_l_100km' => 6.2,
                'image_path' => 'cars/placeholder',
                'description_en' => 'Toyota Camry 2024 USA Spec - 3.5L V6, 301 hp.',
                'description_ku' => 'تۆیۆتا کامری ٢٠٢٤ تایبەتمەندی ئەمریکا.',
            ],
            [
                ...
                'oil_capacity_l' => 6.5, 'oil_density_type' => '0W-20',
